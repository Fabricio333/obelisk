...
- [voice/](voice/README.md) — mesh voice subsystem. Start with `voice/README.md`; deeper material in [voice/mesh-protocol.md](voice/mesh-protocol.md), [voice/mesh-modules.md](voice/mesh-modules.md), [voice/failure-modes.md](voice/failure-modes.md), and [voice/testing.md](voice/testing.md).
...
- [relay-custom-emojis.md](relay-custom-emojis.md) — relay-scoped custom emoji lists, personal stickers, NIP-51/NIP-30 tags, sticker markers, Blossom upload, folder import.
