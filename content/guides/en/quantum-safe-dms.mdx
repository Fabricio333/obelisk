...
Publishing your attestation is what makes you reachable for post-quantum messages — there is nothing else to do on your end. Obelisk will show a per-conversation indicator, built from this same attestation, once that support ships.

## Reading the marks

Once this lands in Obelisk, a conversation you have had for a while will contain messages of different kinds, because both of you may have used several clients over the years. Each message will carry a mark for what it actually had:
...
Only the messages that lack something will be marked, so a healthy conversation will stay quiet.
